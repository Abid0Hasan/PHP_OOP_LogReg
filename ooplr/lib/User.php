...
class User{
	...
	public function userRegistration($data){
        ...
        if ($result) {
        	...
        	$msg = "<div class='alert alert-danger'><strong>Error ! </strong>Sorry , there has been problem inserting 
        	your details !</div>";
	...
	public function userLogin($data){
     ...
     public function updateUserData($id, $data){
        ...
        if ($result) {
        	...
        	$msg = "<div class='alert alert-danger'><strong>Error ! </strong>Sorry , user data not update !</div>";
     ...
     private function checkPassword($id, $old_pass){
     	...
     	$sql = "SELECT password FROM tbl_user WHERE
     ...
     public function updatePassword($id, $data){
        ...
        if ($result) {
        	...
        	$msg = "<div class='alert alert-danger'><strong>Error ! </strong>Sorry , Password not update !</div>";
